<?php
session_start();
    $_SESSION['folder_root'] = '../../../upload/'; // DUONG DAN THU MUC
...
<body class="bg-light">
    ...
    <form action="?ctrl=sanpham&act=insert" method="post" style="border: 1px solid grey"
        class="my-2 col-12 m-auto p-5 row bg-white">
        <div class="box-body col-12">
            <div class="mb-3">
                <label for="exampleInputPassword1" class="form-label h6">Tên sản phẩm</label>
                <input type="text" required class="form-control" name="txtTen" id="exampleInputPassword1">
            </div>
            <div class="mb-3">
            ...
            <div class="mb-3">
                ...
                <input type="number" required class="form-control" name="price" id="exampleInputPassword3">
            </div>
            <div class="mb-3">
                <label for="exampleInputPassword4" class="form-label h6">Giá khuyến mãi</label>
                <input type="number" class="form-control" onchange="checkprice()" name="price2" id="exampleInputPassword4">
            </div>
            <div class="mb-3">
                <label for="exampleInputPassword2" class="form-label h6">Hình ảnh</label>
                <div class="input-group mb-3">
                    <input type="text" required id="exampleInputPassword2" name="img" class="form-control" aria-label="Recipient's username" aria-describedby="basic-addon2">
                ...
                <img src="" alt="" style="width: 200px" id="show_img">
            </div>
            <!-- Modal -->
        ...
        <button type="submit" onclick="myFunction()" class="btn btn-primary m-2 col-2">Thêm sản phẩm</button>
        </div>
    </form>
</body>
...
<script>
    function checkprice(){
        var price = document.QuerySelector("#exampleInputPassword3").value();
        var price2 = document.QuerySelector("#exampleInputPassword4").value();
        if(price2 >= price){
            alert("Lỗi: giá khuyến mãi phải thấp hơn giá gốc");
        }
    }
</script>
</html>