    ...
    <div class="page-header text-blue-d2">
        ...
        <div class="page-tools">
            <div class="action-buttons">
                <a class="btn bg-white btn-light mx-1px text-95" href="?ctrl=donhang&act=edit&id=<?= $getDH['id_hd'] ?>" data-title="Print">
                    <i class="mr-1 fa fa-pencil-square-o text-primary-m1 text-120 w-2"></i>
                    Edit
                </a>
                <a class="btn bg-white btn-light mx-1px text-95 <?php if($getDH['trangthai'] != 3) echo 'disabled' ?>" href="?ctrl=donhang&act=delete&id=<?= $getDH['id_hd'] ?>" onclick="return confirm('Bạn có chắc muốn xóa đơn hàng này?')" data-title="PDF">
                ...
                <div class="row">
                    <div class="col-sm-6">
                        ...
                        <div class="text-grey-m2">
                            ...
                            <div class="my-1"><i class="fa fa-phone fa-flip-horizontal text-secondary"></i> <b class="text-600">Điện thoại: <a href="tel:<?= $getDH['phone']?>"><?= $getDH['phone'] ?></a></b></div>
                            <div class="my-1"><i class="fa fa-envelope" aria-hidden="true"></i> <b class="text-600">Email: <a href="mailto:<?= $getDH['email'] ?>"><?= $getDH['email'] ?></a></b></div>
                        </div>
                    </div>
                    <!-- /.col -->
                    ...
                    <div class="text-95 col-sm-6 align-self-start d-sm-flex justify-content-end">
                        ...
                        <div class="text-grey-m2">
                            ...
                            <div class="my-2"><i class="fa fa-circle text-blue-m2 text-xs mr-1"></i> <span class="text-600 text-90">ID:</span> #<?= $getDH['id_hd'] ?></div>

                            <div class="my-2"><i class="fa fa-circle text-blue-m2 text-xs mr-1"></i> <span class="text-600 text-90">Ngày mua:</span> <?= date('d/m/Y', strtotime($getDH['ngay'])) ?></div>
